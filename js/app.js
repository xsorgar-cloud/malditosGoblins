...
function renderGameWon() {
  ...
  desc.innerHTML = `
    <img src="assets/victoria.webp" style="width: 100%; max-height: 500px; object-fit: cover; border-radius: 8px; margin-bottom: 20px; border: 1px solid rgba(212, 175, 55, 0.5); pointer-events: none; -webkit-user-drag: none; user-select: none;" onerror="this.src='assets/final.webp'">
...
function renderGameOver() {
  ...
  desc.innerHTML = `
    <img src="assets/final.webp" style="width: 100%; max-height: 300px; object-fit: cover; border-radius: 8px; margin-bottom: 20px; border: 1px solid rgba(230, 57, 70, 0.5); pointer-events: none; -webkit-user-drag: none; user-select: none;">
