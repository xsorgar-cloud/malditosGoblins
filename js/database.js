const DB = {
  ...
  roles: [
    ...
    { id: 'sanador', name: 'Sanador', image: 'assets/Roles/rol_sanador.jpg', icon: 'assets/Roles/ico_rol_sanador.png', effect: 'Cura PV a tí mismo o a un compañero.', energyRates: [0, 2, 3, 3, 3, 1] },
