  ...
  if (roleId === 'curandero') {
    ...
    if (activeGoblins.length === 0) {
      ...
      activeGoblins.forEach(gob => {
        ...
        gbtn.innerHTML = `
          <div class="goblin-hp" style="width: 56px !important; height: 56px !important; top: 19px !important; right: 134px !important; font-size: 1.7rem !important; padding-bottom: 4px; box-shadow: none !important;">${gob.currentHp}</div>
